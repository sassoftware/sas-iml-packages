/* Install_Pkg.sas: Loads all NMF modules into the SAS/IML environment */

%put Loading NMF package modules...;
...
proc iml;
%include "&repoPath/NMF/nmf_Define.sas";  /* one file with all modules */
quit;

%put NMF package loaded.;
