...
/* The tests in this file are as follows:
   ...
   7. QUAD 'gotcha': Need to manually switch the sign of the integral from CALL QUAD when integrating on [c,d] and c > d.
   8. Iterate over all possible signs of a 3x3 correlation matrix.
*/
proc iml;
load module=_all_;
