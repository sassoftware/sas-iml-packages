...
start MLE_Summary(L, printOpt=1);
   ...
   print T [label=labl rowname=(L$"ParmNames") format=8.4 
            colname={"Estimate" "StdErr"}];
   ...
   if printOpt > 2 then do;
      ...
      print (L$"Hessian") [label="Hessian at Estimate" colname=(L$"ParmNames") rowname=(L$"ParmNames") format=8.4];
   end;  
finish;
